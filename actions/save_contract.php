...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt_contract->bind_param("iiissiddisi", $client_id_for_contract, $coach_id, $coach_id, $start_date_str, $package_name, $total_sessions, $total_price, $discount_percentage, $final_price, $payment_type, $paid_amount);
